...
export class LoginComponent {
  ...
  changeTheme() {
    ...
    let fetchedrecord = this.fetchDataFromEntireStore.find(theme => theme.prime === this.fetchedColors.primaryColor && theme.secondary === this.fetchedColors.secondaryColor)
